...
export class PaginationComponent {
    @Input() vehiclePerPage: number = 10; // Number of rooms per page
    @Input() totalVehicle: number = 0; // Total number of rooms
    ...
    @Output() paginate: EventEmitter<number> = new EventEmitter<number>(); // Emit page number
      ...
      get pageNumbers(): number[] {
        const pageCount = Math.ceil(this.totalVehicle / this.vehiclePerPage);
